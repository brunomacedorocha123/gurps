...
class CatalogoEquipamentos {
        ...
        this.catalogo = {
            "medieval": {
                "armasCorpoACorpo": [
                    ...
                    {
                        id: "M801", nome: "Espada Longa", tipo: "arma-cc", era: "medieval", nt: 0,
                        dano: "2d+2", tipoDano: "corte", alcance: "1,2", peso: 3.0, st: 10, custo: 600,
                        maos: 1.5, quantificavel: false, descricao: "Espada longa versátil"
                    },
                    {
                ...
                "armasDistancia": [
                    {
                        ...
                        st: 9, custo: 800, magnit: "Munição 9mm", maos: 1, quantificavel: false,
                    ...
                    },
                    {
                        ...
                        quantificavel: false, descricao: "Rifle de assalto automático"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        st: 8, custo: 5000, magnit: "Célula de Energia", maos: 1, quantificavel: false,
    ...
    atualizarTabelaCategoria(categoria, equipamentos) {
        ...
        // *** CORREÇÃO DO BUG DA DUPLICAÇÃO ***
        // NÃO ADICIONAR EVENTOS AQUI - já são tratados pelo sistema principal
    }
