// vantagens.js - VERSÃO CORRIGIDA E FUNCIONAL
class SistemaVantagens {
    ...
    confirmarSelecaoOpcao() {
        // Verificar se tem opção selecionada
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Atualizar peculiaridades ao carregar
    setTimeout(() => {
